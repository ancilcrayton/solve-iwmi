...
### Data ETL
If you raw data file is too large to be loaded at once into Elastic Search, you can split it into smaller chunks:
    
    jq -c . < full_data_pull.json | split -l 10000  --additional-suffix=.json - chunk_
